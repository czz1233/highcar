...
<meta charset="UTF-8">
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="updateTrain.do" method="post" >
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>修改列车信息</STRONG>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="train_tno" value="${train.getTrain_tno()}" id="train_tno" class="bg"/>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="start" value="${train.getStart()}" id="start"/>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						目的地
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="end" value="${train.getEnd()}" id="end" class="bg"/>
					</td>
				</tr>
                <tr>
                    <td align="center" bgColor="#f5fafe" class="ta_01">
                    ...
                    <td class="ta_01" bgColor="#ffffff">
                        <input type="text" name="totle" value="${train.getTotle()}" id="totle"/>
                    </td>
                </tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff">
						                <div class="controls input-append date form_datetime" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
						                   	<input type="text" style="margin-top:24px;width:250px;" value="${train.getStartTime()}" name="startTime" class="bg"/>
	...
	$('.form_time').datetimepicker({
		...
		forceParse: 0
					...
					<td class="ta_01" bgColor="#ffffff">
						                ...
						                <div class="controls input-append date form_datetime" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
						                    <input type="text" style="margin-top:24px;width:250px;" value="${train.getEndTime()}" class="bg" name="endTime"/>
						                   	<span class="add-on" style="margin-top:24px"><i class="icon-remove"></i></span>
						                   	<span class="add-on" style="margin-top:24px"><i class="icon-th"></i></span>
						                </div>
